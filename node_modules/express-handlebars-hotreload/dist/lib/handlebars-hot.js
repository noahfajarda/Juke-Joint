...
var ExpressHandlebars = /** @class */ (function () {
    ...
    ExpressHandlebars.prototype.renderView = function (viewPath, options, callback) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var context, promise, view, views, viewsPath, encoding, helpers, partials, _b, renderOptions, html, layoutPath, err_2;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        partials = __assign.apply(void 0, [__assign.apply(void 0, _b.concat([_c.sent()])), (options.partials || {})]);
                        renderOptions = {
                            cache: options.cache,
                            encoding: encoding,
                            view: view,
                    ...
                    case 5:
                        if (this.config.hotreload) {
                            html += "\n\t\t\t\t\t<script>\n\t\t\t\t\t\t(() => {\n\t\t\t\t\t\t\t// client.ts\n\t\t\t\t\t\t\tvar ws = new WebSocket(\"ws://localhost:".concat(typeof this.config.hotreload === 'object' ? (_a = this.config.hotreload) === null || _a === void 0 ? void 0 : _a.port : 8080, "\");\n\t\t\t\t\t\t\tws.addEventListener(\"open\", () => {\n\t\t\t\t\t\t\t\tconsole.log(\"\uD83D\uDD25 Listening for updates...\");\n\t\t\t\t\t\t\t});\n\t\t\t\t\t\t\tws.addEventListener(\"message\", function(event) {\n\t\t\t\t\t\t\t\tconsole.log(\"\uD83D\uDD25 Received message:\", event.data);\n\t\t\t\t\t\t\t\tif (event.data === \"refresh\") {\n\t\t\t\t\t\t\t\t\tconsole.log(\"\uD83D\uDD25 Refreshing the page...\");\n\t\t\t\t\t\t\t\t\twindow.location.reload();\n\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t});\n\t\t\t\t\t\t\tws.addEventListener(\"close\", () => {\n\t\t\t\t\t\t\t\tconsole.log(\"\uD83D\uDD25 Connection closed\");\n\t\t\t\t\t\t\t});\n\t\t\t\t\t\t})();\n\t\t\t\t\t</script>\t\t\t\n\t\t\t\t");
                        }
                        callback(null, html);
                        return [3 /*break*/, 7];
                    case 6:
...
//# sourceMappingURL=handlebars-hot.js.map